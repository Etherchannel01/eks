...
resource "aws_vpc_security_group_egress_rule" "eks_cluster_sg_tcp_53_egress_rule" {
  ...
  description                  = "Allow egress traffic on port 53 (DNS) for TCP within the security group"
}
...
resource "aws_vpc_security_group_egress_rule" "eks_cluster_sg_443_egress_rule" {
  ...
  ip_protocol                  = "tcp"
  referenced_security_group_id = data.aws_eks_cluster.eks_cluster.vpc_config[0].cluster_security_group_id
  description                  = "Allow egress traffic on port 443 (HTTPS) within the security group"
}
...
resource "aws_vpc_security_group_egress_rule" "eks_cluster_sg_10250_egress_rule" {
  ...
  ip_protocol                  = "tcp"
  referenced_security_group_id = data.aws_eks_cluster.eks_cluster.vpc_config[0].cluster_security_group_id
  description                  = "Allow egress traffic on port 10250 (Kubelet API) within the security group"
}
...
resource "aws_vpc_security_group_egress_rule" "eks_cluster_sg_udp_53_egress_rule" {
  ...
  ip_protocol                  = "udp"
  referenced_security_group_id = data.aws_eks_cluster.eks_cluster.vpc_config[0].cluster_security_group_id
  description                  = "Allow egress traffic on port 53 (DNS) for UDP within the security group"
}
